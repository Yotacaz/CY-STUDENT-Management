...
\begin{DoxyCompactList}\small\item\em compare two students by their IDs. To be used in qsort for sorting in growing order \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em compare two students by their IDs. To be used in bsearch \end{DoxyCompactList}\item 
...
compare two students by their IDs. To be used in bsearch 
...
compare two students by their IDs. To be used in qsort for sorting in growing order 
